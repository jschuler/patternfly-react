...
const ModalContent = ({
  ...
  return (
    <Backdrop>
      <Bullseye>
        <AboutModalBox className={className} ariaLablledbyId={ariaLablledbyId} ariaDescribedById={ariaDescribedById}>
          <AboutModalBoxBrand src={brandImageSrc} alt={brandImageAlt} />
          <AboutModalBoxCloseButton onClose={onClose} />
          <AboutModalBoxHeader id={ariaLablledbyId} productName={productName} trademark={trademark} />
